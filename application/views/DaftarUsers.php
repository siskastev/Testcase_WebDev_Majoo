	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url()?>templatelogin/images/bg-01.jpg');">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo base_url('Login/prosesDaftar') ?>" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter alamat">
						<textarea class="input100" type="text" name="alamat" placeholder="alamat" required=""></textarea>
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Enter hp">
						<input class="input100" type="text" name="hp" placeholder="hp">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
