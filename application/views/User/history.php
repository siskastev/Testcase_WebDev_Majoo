     ...
     foreach ($order as $key) 
     {
      ...
      <tr>
        ...
        <?php } elseif ($key->konfirmasi == 1) {?>
          <td><a href="<?php echo base_url('UserDashboard/konfirmasi/'.$key->id_order)?>" class="btn btn-info">Konfirmasi</a></td>
        <?php } elseif ($key->konfirmasi == 2) { ?>
          <td>Selesai</td>
        <?php  } ?>
        <td><a href="<?php echo base_url('UserDashboard/detilTrans/'.$key->id_order)?>" class="btn btn-success">Lihat Detail</a></td>
