      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="active nav-link" href="<?php echo base_url('Home') ?>">Home
          ...
          <li>
            <a  class="nav-link" href="<?php echo base_url()?>Shop/keranjang_belanja">Keranjang<i class="fa fa-cart-plus"></i> <?php echo count($cart); ?></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('Login/LoginUsers') ?>">Login</a>
          </li>
        </ul>
      </div>
    </div>
